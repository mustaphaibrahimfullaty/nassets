...
export function HeroSection() {
  return (
    <section className="relative min-h-[90vh] flex items-center -mt-20 pt-32 pb-20 overflow-hidden mesh-gradient dot-grid">
      {/* Bottom fade for smooth blending with the page */}
      <div className="absolute bottom-0 left-0 right-0 h-48 bg-linear-to-t from-background via-background/80 to-transparent pointer-events-none z-0" />
